...
/**
 * @file
 * Default theme implementation to display a "Rapport d'études" node.
 */

$date_maj = format_date($changed, 'custom', 'F Y');
    ...
    <div class="rte">
      <div class="content"<?php print $content_attributes; ?>>
        ...
        <?php if (!empty($content['field_lien_telechargement'])): ?>
          <a href="<?php echo file_create_url($content['field_lien_telechargement']['#items'][0]['uri']); ?>"

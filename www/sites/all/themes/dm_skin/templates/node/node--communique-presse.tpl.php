...
/**
 * @file
 * Default theme implementation to display a "Communique de presse" node.
 */

$date_sortie_pub = format_date($content['field_date_sortie_publication']['#items'][0]['value'], 'custom', 'F Y');
...
<article id="node-<?php print $node->nid; ?>" class="bloc-article <?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <?php if ($date_sortie_pub): ?>
    <div class="complement-titre">
      <?php echo $date_sortie_pub ?>
    </div>
  <?php endif; ?>
    ...
    <div class="rte">
      <div class="content"<?php print $content_attributes; ?>>
        ...
        <?php if (!empty($content['field_lien_telechargement'])): ?>
          <a href="<?php echo file_create_url($content['field_lien_telechargement'][0]['#items'][0]['uri']); ?>"
        ...
        <?php if (!empty($content['field_tags'])): ?>
          <p><span class="label">Tags</span>
            : <?php print render($content['field_tags']); ?></p>
        <?php endif; ?>
